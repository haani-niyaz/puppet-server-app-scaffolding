...
shared_context :global_hiera_data do
  let(:hiera_data) do
     {
       #"ovs_mule_server::config::server_package_version" => '',
       #"ovs_mule_server::install::app_package_name" => '',
       #"ovs_mule_server::install::repo_name" => '',
       #"ovs_mule_server::install::server_package_name" => '',
       #"ovs_mule_server::install::server_package_version" => '',
       #"ovs_mule_server::mule_app_package" => '',
       #"ovs_mule_server::mule_server_on_boot" => '',
       #"ovs_mule_server::mule_server_package" => '',
       #"ovs_mule_server::mule_server_status" => '',
       #"ovs_mule_server::mule_server_version" => '',
       #"ovs_mule_server::repo_name" => '',
       #"ovs_mule_server::service::mule_server_on_boot" => '',
       #"ovs_mule_server::service::mule_server_status" => '',
